...
public class OrderDetailsActivity_ViewBinding<T extends OrderDetailsActivity> implements Unbinder {
  ...
  public OrderDetailsActivity_ViewBinding(T target, View source) {
    ...
    target.cloer_tv = Utils.findRequiredViewAsType(source, R.id.cloer_tv, "field 'cloer_tv'", TextView.class);
    target.zhifu_tv = Utils.findRequiredViewAsType(source, R.id.zhifu_tv, "field 'zhifu_tv'", TextView.class);
    target.yes_shou_tv = Utils.findRequiredViewAsType(source, R.id.yes_shou_tv, "field 'yes_shou_tv'", TextView.class);
  }
  ...
  public void unbind() {
    ...
    target.cloer_tv = null;
    target.zhifu_tv = null;
    target.yes_shou_tv = null;
