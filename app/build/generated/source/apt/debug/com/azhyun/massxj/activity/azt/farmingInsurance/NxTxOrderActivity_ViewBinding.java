...
public class NxTxOrderActivity_ViewBinding<T extends NxTxOrderActivity> implements Unbinder {
  ...
  public NxTxOrderActivity_ViewBinding(T target, View source) {
    ...
    target.gong_nongyuzhi = Utils.findRequiredViewAsType(source, R.id.gong_nongyuzhi, "field 'gong_nongyuzhi'", TextView.class);
    ...
    target.diyong_price = Utils.findRequiredViewAsType(source, R.id.diyong_price, "field 'diyong_price'", TextView.class);
    ...
    target.select = Utils.findRequiredViewAsType(source, R.id.select, "field 'select'", RadioButton.class);
  }
  ...
  public void unbind() {
    ...
    target.number = null;
    target.gong_nongyuzhi = null;
    target.nb_heji = null;
    target.nb_xia_heji = null;
    target.diyong_price = null;
