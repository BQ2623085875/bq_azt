...
public class MyLandHostingActivity_ViewBinding<T extends MyLandHostingActivity> implements Unbinder {
  protected T target;

  @UiThread
  public MyLandHostingActivity_ViewBinding(T target, View source) {
    this.target = target;
