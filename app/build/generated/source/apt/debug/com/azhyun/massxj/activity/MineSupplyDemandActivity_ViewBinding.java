...
public class MineSupplyDemandActivity_ViewBinding<T extends MineSupplyDemandActivity> implements Unbinder {
  protected T target;

  @UiThread
  public MineSupplyDemandActivity_ViewBinding(T target, View source) {
    this.target = target;
