...
public class BaoAgriculturaFragment_ViewBinding<T extends BaoAgriculturaFragment> implements Unbinder {
  protected T target;

  @UiThread
  public BaoAgriculturaFragment_ViewBinding(T target, View source) {
    this.target = target;
