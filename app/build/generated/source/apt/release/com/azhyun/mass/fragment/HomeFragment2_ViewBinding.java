...
public class HomeFragment2_ViewBinding<T extends HomeFragment2> implements Unbinder {
  ...
  public HomeFragment2_ViewBinding(T target, View source) {
    ...
    target.homeCombo = Utils.findRequiredViewAsType(source, R.id.home_combo, "field 'homeCombo'", AutoLinearLayout.class);
    ...
    target.homeSow = Utils.findRequiredViewAsType(source, R.id.home_sow, "field 'homeSow'", AutoLinearLayout.class);
    target.homePesticide = Utils.findRequiredViewAsType(source, R.id.home_pesticide, "field 'homePesticide'", AutoLinearLayout.class);
    target.homeHarvest = Utils.findRequiredViewAsType(source, R.id.home_harvest, "field 'homeHarvest'", AutoLinearLayout.class);
    ...
    target.xRecyclerView = Utils.findRequiredViewAsType(source, R.id.recycler_view, "field 'xRecyclerView'", XRecyclerView.class);
    target.titleMessage = Utils.findRequiredViewAsType(source, R.id.title_message, "field 'titleMessage'", ImageView.class);
    target.tvXiao = Utils.findRequiredViewAsType(source, R.id.tv_xiao, "field 'tvXiao'", TextView.class);
  }
