...
public class ReleaseTheSupplyActivity_ViewBinding<T extends ReleaseTheSupplyActivity> implements Unbinder {
  ...
  public ReleaseTheSupplyActivity_ViewBinding(T target, View source) {
    ...
    target.recycler_view2 = Utils.findRequiredViewAsType(source, R.id.recycler_view2, "field 'recycler_view2'", RecyclerView.class);
    target.layoutBeforeUploading = Utils.findRequiredViewAsType(source, R.id.layout_before_uploading, "field 'layoutBeforeUploading'", ImageView.class);
    target.layout_before_uploading2 = Utils.findRequiredViewAsType(source, R.id.layout_before_uploading2, "field 'layout_before_uploading2'", ImageView.class);
  ...
  public void unbind() {
    ...
    target.recycler_view2 = null;
    target.layoutBeforeUploading = null;
    target.layout_before_uploading2 = null;
    target.bank = null;
    target.title = null;
