...
public class CaiGouSubmitOrderActivity_ViewBinding<T extends CaiGouSubmitOrderActivity> implements Unbinder {
  protected T target;

  @UiThread
  public CaiGouSubmitOrderActivity_ViewBinding(T target, View source) {
    this.target = target;
