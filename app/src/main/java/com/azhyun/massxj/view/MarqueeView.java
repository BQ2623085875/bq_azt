...
//        if (notices == null || notices.size() == 0) return false;
        removeAllViews();
            ...
            for (int i = 0; i < notices.size(); i++) {
                final LinearLayout linearLayout = createLinearLayout(notices.get(i), i);
                final int finalI = i;
                linearLayout.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (onItemClickListener != null) {
                            onItemClickListener.onItemClick(finalI, linearLayout);
                        }
                    }
                });
    ...
    private LinearLayout createLinearLayout(String text, int position) {
        ...
        textView.setTextColor(Color.parseColor("#ff3c05"));
...
//        linearLayout.addView(textView);
    ...
    public interface OnItemClickListener {
        void onItemClick(int position, LinearLayout linearLayout);
    }
