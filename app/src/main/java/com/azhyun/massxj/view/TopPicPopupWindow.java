...
public class TopPicPopupWindow extends PopupWindow {
    ...
    public TopPicPopupWindow(Activity context, final List<GongXuFenLeiBean.DataBeanX.ChildBean> list, final OnItemClickListener onItemClickListener) {
        super(context);
        mContent = context;
