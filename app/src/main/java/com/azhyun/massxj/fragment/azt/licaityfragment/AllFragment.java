...
public class AllFragment extends LazyLoadFragment {
    protected final String TAG = "AllFragment";
    ...
    private void gainiData() {
        ...
        Call<GongQiuBean> benDiGQ = service.getBenDiGQ(null, mFenLeiString, currentPager, 10, User.INSTANCE.getRegion(), null, null);
