 ...
 * 本地生活 求购
 */
public class AskFragment extends LazyLoadFragment {
    protected final String TAG = "AskFragment";
    ...
    private void gainiData() {
        ...
        Call<GongQiuBean> benDiGQ = service.getBenDiGQ(null, mFenLeiString, currentPager, 10, User.INSTANCE.getRegion(), 2, null);
