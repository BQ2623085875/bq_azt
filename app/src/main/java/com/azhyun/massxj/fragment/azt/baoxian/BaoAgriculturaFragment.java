package com.azhyun.massxj.fragment.azt.baoxian;
...
public class BaoAgriculturaFragment extends LazyLoadFragment {
    ...
    @SuppressLint("ValidFragment")
    public BaoAgriculturaFragment(Integer integer) {
    ...
    protected void lazyLoad() {
        initView();
        gainData();
        wushuju.setBackgroundColor(getResources().getColor(R.color.black));
    }
...
//            holder.meimu_price.setText(rowsBean.getAmount());
//            holder.zeren.setText(rowsBean.getResponsibility());
//
