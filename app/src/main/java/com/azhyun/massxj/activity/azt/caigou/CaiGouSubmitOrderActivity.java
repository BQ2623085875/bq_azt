...
* 提交订单
* */
public class CaiGouSubmitOrderActivity extends BaseActivity {
    ...
    private CaiGouXQBean.DataBeanX data;
    private int guigeid;
    private int type;
    ...
    protected int getLayoutId() {
        return R.layout.activity_caigou_submit_order;
    }
    ...
    protected void initView() {
        ...
        data = (CaiGouXQBean.DataBeanX) getIntent().getSerializableExtra("data");
        ...
        submit_shuliang.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                Log.d("88888888888888888", s.toString() + "====");
                qty = s.toString();
        ...
        SoftKeyBoardListener.setListener(CaiGouSubmitOrderActivity.this, new SoftKeyBoardListener.OnSoftKeyBoardChangeListener() {
            @Override
    ...
    private void gainData() {
        LoadingDialog.show(CaiGouSubmitOrderActivity.this);
...
//                        danwei.setText("/" + orderData.get(0).getItemList().get(0).getUnits());
                        ...
                        Glide.with(CaiGouSubmitOrderActivity.this).load(Constant.IMG_URL + orderData.get(0).getItemList().get(0).getImg()).into(submit_commodity_img);
                    } else {
                        ToastUtils.showToast(CaiGouSubmitOrderActivity.this, body1.getResult().getMessage());
                        LoadingDialog.cancel();
                    }
                } else {
                    LoadingDialog.cancel();
    ...
    * */
    private void submitOrder() {
        ...
        HttpService service = ServiceGenerator.createService(HttpService.class);
        Call<ResultBean> tijiaoorder = service.caigoutijiaoorder(dicStrMap);
            ...
            public void onResponse(Call<ResultBean> call, Response<ResultBean> response) {
                if (response.isSuccessful()) {
                    ...
                    if (body.getResult().getCode().equals("200")) {
                        Intent intent = new Intent(CaiGouSubmitOrderActivity.this, CaiGouDingDanLieBiaoActivity.class);
                        intent.putExtra("tiem", 1);
                        startActivity(intent);
                        finish();
                        ToastUtils.showToast(CaiGouSubmitOrderActivity.this, "提交成功!");
                    } else {
                        LoadingDialog.cancel();
                        ToastUtils.showToast(CaiGouSubmitOrderActivity.this, body.getResult().getMessage());
                    }
                } else {
                    LoadingDialog.cancel();
                }
        ...
        switch (view.getId()) {
            ...
            case R.id.submit_tijiao://提交订单
                ...
                if (zuixiaoshuliang <= s) {
                    ...
                    ToastUtils.showToast(CaiGouSubmitOrderActivity.this, "最小起订量为" + zuixiaoshuliang);
                }
                break;
            case R.id.submit_commodity_jianhao:
                if (amount > 1) {
                    ...
                    ToastUtils.showToast(CaiGouSubmitOrderActivity.this, "不能再减了！");
                }
                break;
            case R.id.submit_commodity_jiahao:
                if (amount > 0) {
                    if (equal < 999) {
                        ...
                        ToastUtils.showToast(CaiGouSubmitOrderActivity.this, "最大起订量为999！");
                    }
                }
                break;
        }
